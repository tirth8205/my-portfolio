    ...
    >
      ...
      <div className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-darkGreen/80">
        {projects?.map((project, i) => {
          // Log the technologies array for this project
          console.log(`Technologies for project "${project.title}":`, project.technologies);
          ...
          return (
            ...
            >
              <motion.img
                ...
                src={project?.image ? urlFor(project.image).url() : "/placeholder-project.png"}
                alt=""
              />
