...
export default function ContactMe({ }: Props) {
  ...
  return (
    ...
    >
      <h3 className="absolute left-0 right-0 mx-auto text-center top-16 sm:top-20 md:top-24 uppercase tracking-[6px] sm:tracking-[8px] text-gray-500 text-lg sm:text-xl md:text-2xl">
        Contact
      </h3>
      ...
      <div className="flex flex-col space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-4 xl:space-y-3 w-full mt-16 sm:mt-18 md:mt-20 lg:mt-12 xl:mt-8 max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl mx-auto">
        <h4 className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-semibold text-center leading-relaxed">
          ...
          <span className="decoration-primary/50 underline">Let&apos;s join forces</span> and make magic happen. Coffee&apos;s on me – unless you prefer tea!
        </h4>

        <div className="space-y-3 md:space-y-0 md:flex md:flex-row md:space-x-6 md:justify-center md:items-center md:flex-wrap">
          <div className="flex items-center justify-center space-x-3">
            <PhoneIcon className="text-primary h-5 w-5 md:h-6 md:w-6" />
            <p className="text-sm md:text-base">+44 7741918549</p>
          </div>
          <div className="flex items-center justify-center space-x-3">
            <EnvelopeIcon className="text-primary h-5 w-5 md:h-6 md:w-6" />
            <p className="text-sm md:text-base">tirthkanani18@gmail.com</p>
          </div>
          <div className="flex items-center justify-center space-x-3">
            <MapPinIcon className="text-primary h-5 w-5 md:h-6 md:w-6" />
            <p className="text-sm md:text-base">London, United Kingdom</p>
          </div>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            className="bg-gradient-to-r from-primary to-secondary py-2 sm:py-3 md:py-4 px-4 sm:px-6 md:px-10 rounded-md text-white font-bold text-xs sm:text-sm md:text-base"
